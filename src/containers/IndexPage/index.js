...
import MdDownload from 'react-icons/lib/fa/cloud-download';
      ...
      <div>
        ...
        <Grid width="100%">
            <Row  style={{height:'90%', padding:'8px'}}>
              <Col md={4}>
                <h2 style={{color:"#878C95"}}><Icon className="icon icon-download" name="cloud-download fa-2x" />DOWNLOAD </h2>
                <p>
              ...
              <Col md={4}>
                <h2><Icon className="icon icon-share " name="share-alt-square fa-2x" />SHARE </h2>
                <p>
                  Jump-start your automation project with great content from the Ansible community. Galaxy provides pre-packaged units of work known to Ansible as roles
                </p>
                <p>
              ...
              <h2><MdStar style={{color:'#FFFFFF'}} /> FEATURED</h2>
                <div className="content-feature">
                  <p>ROLE:jdauphant.nginx - Ansible role to install and manage nginx configuration </p>
                </div>
                <div className="content-feature">
                  <p>AUTHOR:andrewrothstein with 239 roles. </p>
                </div>
                <div className="content-feature">
                  <p>BLOG: Read the latest from The Inside Playbook, and keep up with what &#39;s happening in the Ansible universe.</p>
                </div>
              </Col>
            </Row>
